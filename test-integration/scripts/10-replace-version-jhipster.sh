...
sed -e '/<artifactId>jhipster-parent<\/artifactId>/{N;s/<version>.*<\/version>/<version>'$JHI_VERSION'<\/version>/1;}' jhipster-framework/pom.xml > jhipster-framework/pom.xml.sed
