...
public class ConditionBuilderTest {
	...
	void testUsingDurationTypeSingleFilter()
		...
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go != '21600000'");
	}
	...
	void testUsingDurationTypeWithAllFilters()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go > '21600000' AND c.time_to_go < '21600000' AND c.time_to_go >= '21600000' "
	...
	void testUsingDurationTypeWithUultipleIn()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals(
	...
	void testUsingDurationTypeWithUultipleNotIn()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go != '21600000' AND c.time_to_go NOT IN ('21600000', '21600010')");
	}
	...
	void testUsingZonedDateTimeTypeSingleFilter()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go != '1970-01-01T00:00'");
	}
	...
	void testUsingZonedDateTimeTypeWithAllFilters()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go > '1970-01-01T00:00' AND c.time_to_go < '1970-01-01T00:00' "
	...
	void testUsingStringTypeSingleFilter() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go != 'HAPPY_FILTER'");
	}
	...
	void testUsingStringTypeWithAllFilters() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go LIKE 'HAPPY_FILTER' AND c.time_to_go NOT LIKE 'HAPPY_FILTER' AND "
	...
	void testUsingBooleanTypeSingleFilter() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go != true");
	}
	...
	void testUsingBooleanTypeWithAllFilters() throws IllegalAccessException, InvocationTargetException {
		BooleanFilter testDuration = (BooleanFilter) new ConditionTestHelper(Arrays.asList(), Arrays.asList(),
				generalFilterSetters, true).buildGeneralConditions(new BooleanFilter(), TEST_BOOLEAN_TRUE,
						TEST_BOOLEAN_FALSE);
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go = true AND c.time_to_go != true "
	...
	void testUsingBooleanTypeWithMultipleIn() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go = true AND c.time_to_go IN (true, false) AND c.time_to_go IS NULL");
	}
	...
	void testUsingDBooleanTypeWithMultipleNotIn() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go != true AND c.time_to_go NOT IN (true, false)");
	}
	...
	void testUsingLongTypeSingleFilter() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go != '123'");
	}
	...
	void testUsingLongTypeWithAllFilters() throws IllegalAccessException, InvocationTargetException {
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go > '123' AND c.time_to_go < '123' AND c.time_to_go >= '123' "
	...
	void testUsingLongTypeWithUultipleIn()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go = '123' AND c.time_to_go IN ('123', '124') AND c.time_to_go IS NULL");
	}
	...
	void testUsingLongTypeWithUultipleNotIn()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go != '123' AND c.time_to_go NOT IN ('123', '124')");
	}
	...
	void testUsingBigDecimalTypeWithUultipleIn()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go = '123' AND c.time_to_go IN ('123', '1') AND c.time_to_go IS NULL");
	}
	...
	void testUsingBigDecimalTypeWithUultipleNotIn()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go != '123' AND c.time_to_go NOT IN ('123', '1')");
	}
	...
	void testUsingDoubleTypeWithAllFilters()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go > '123.0' AND c.time_to_go < '123.0' AND c.time_to_go >= '123.0' "
	...
	void testUsingDoubleTypeOnlySpecified()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString()).contentEquals("c.time_to_go IS NULL");
	}
	...
	void testUsingDoubleTypeGeneralFilter()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go = '123.0' AND c.time_to_go != '123.0' "
	...
	void testUsingIntegerTypeWithOnlyGeneral()
		...
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go = '123' AND c.time_to_go != '123' "
	...
	void testUsingEnumTypeWithGeneralFilters()
		...
		TestEnumFilter testDuration = (TestEnumFilter) new ConditionTestHelper(Arrays.asList(), Arrays.asList(),
				generalFilterSetters, false).buildGeneralConditions(new TestEnumFilter(), TestEnum.ENUM1, TestEnum.ENUM2);
		setupBuilder(testDuration);
		assert (builder.buildConditions().toString())
				.contentEquals("c.time_to_go = 'ENUM1' AND c.time_to_go != 'ENUM1' "
