...
public class ZonedDateTimeFilterTest {
    ...
    public void testSetLike() {
        Filter<ZonedDateTime> chain = filter.setLike("like");
        assertThat(chain).isEqualTo(filter);
    ...
    public void testToString() {
        ...
        assertThat(filter.toString()).isEqualTo("ZonedDateTimeFilter [equals=" + str + ", notEquals=" + str + ", specified=true, like=like, in=[], notIn=[], greaterThan=" + str + ", lessThan=" + str + ", greaterThanOrEqual=" + str + ", lessThanOrEqual=" + str + "]");
    }
}
