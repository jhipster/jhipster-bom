...
public class LocalDateFilterTest {
    ...
    public void testSetLike() {
        Filter<LocalDate> chain = filter.setLike("like");
        assertThat(chain).isEqualTo(filter);
    ...
    public void testToString() {
        ...
        assertThat(filter.toString()).isEqualTo("LocalDateFilter [equals=" + str + ", notEquals=" + str + ", specified=true, like=like, in=[], notIn=[], greaterThan=" + str + ", lessThan=" + str + ", greaterThanOrEqual=" + str + ", lessThanOrEqual=" + str + "]");
    }
}
