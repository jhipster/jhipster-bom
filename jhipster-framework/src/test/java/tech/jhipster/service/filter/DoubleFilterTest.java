...
public class DoubleFilterTest {
    ...
    public void testSetLike() {
        Filter<Double> chain = filter.setLike("like");
        assertThat(chain).isEqualTo(filter);
    ...
    public void testToString() {
        ...
        assertThat(filter.toString()).isEqualTo("DoubleFilter [equals=" + str + ", notEquals=" + str + ", specified=true, like=like, in=[], notIn=[], greaterThan=" + str + ", lessThan=" + str + ", greaterThanOrEqual=" + str + ", lessThanOrEqual=" + str + "]");
    }
}
