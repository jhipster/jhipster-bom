...
public class LongFilterTest {
    ...
    public void testSetLike() {
        Filter<Long> chain = filter.setLike("like");
        assertThat(chain).isEqualTo(filter);
    ...
    public void testToString() {
        ...
        assertThat(filter.toString()).isEqualTo("LongFilter [equals=" + str + ", notEquals=" + str + ", specified=true, like=like, in=[], notIn=[], greaterThan=" + str + ", lessThan=" + str + ", greaterThanOrEqual=" + str + ", lessThanOrEqual=" + str + "]");
    }
}
