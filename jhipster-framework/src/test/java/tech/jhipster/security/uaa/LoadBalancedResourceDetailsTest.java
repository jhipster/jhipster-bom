...
import static tech.jhipster.security.uaa.LoadBalancedResourceDetails.EXCEPTION_MESSAGE;
...
public class LoadBalancedResourceDetailsTest {
    ...
    public void testWithoutClient() {
        LoadBalancedResourceDetails details = Mockito.spy(new LoadBalancedResourceDetails(null));
    ...
    public void testWithClient() {
        LoadBalancedResourceDetails details = Mockito.spy(new LoadBalancedResourceDetails(client));
        details.setAccessTokenUri(ACCESS_TOKEN_URI);
        assertThat(details.getAccessTokenUri()).isEqualTo(ACCESS_TOKEN_URI);
        verify(client, never()).reconstructURI(any(), any());
