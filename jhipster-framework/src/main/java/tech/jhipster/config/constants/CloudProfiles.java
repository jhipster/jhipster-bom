 ...
 */
package tech.jhipster.config.constants;

/**
 * Constants related to cloud deployment environments.
 */
public interface CloudProfiles {
    /** Spring Cloud deployment profile */
    String SPRING_PROFILE_CLOUD = "cloud";
    /** Heroku deployment profile */
    String SPRING_PROFILE_HEROKU = "heroku";
    /** Kubernetes and OpenShift deployment profile */
