...
import static tech.jhipster.security.jwt.JWTFilter.AUTHORIZATION_HEADER;

/**
 * When using a Spring Cloud Gateway, this relays the JWT tokens to the microservices.
 */
